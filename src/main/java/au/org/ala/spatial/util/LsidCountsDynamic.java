            ...
            public void run() {
                ...
                try {
                    ...
                    for (String lsidLevel : lsidLevels) {
                        ...
                        org.json.simple.JSONArray facetResults =  (org.json.simple.JSONArray) jo.get("facetResults");

                        if(!facetResults.isEmpty()){

                            org.json.simple.JSONArray ja = (org.json.simple.JSONArray) ((org.json.simple.JSONObject) facetResults.get(0)).get("fieldResult");
