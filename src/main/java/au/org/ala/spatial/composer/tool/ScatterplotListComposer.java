...
public class ScatterplotListComposer extends ToolComposer {
    ...
    public boolean onFinish() {
        ...
        lsid = lsid.newFacet(new Facet(StringConstants.OCCURRENCE_STATUS, "absent", false), false);
        ...
        backgroundLsid = backgroundLsid.newFacet(new Facet(StringConstants.OCCURRENCE_STATUS, "absent", false), false);
